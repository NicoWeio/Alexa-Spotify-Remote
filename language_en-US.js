module.exports = {
  translation: {
    ...
    WELCOME_NO_TOKEN: "Welcome to “Playback control”, the unofficial remote for Spotify. In order to use this skill, you need to link it to Spotify. Just open the Alexa app and follow the instructions.",
    WELCOME_REPROMPT: "What would you like to do? If you need help, just say “help”.",
    HELP: "Here is a short introduction in den Skill “Playback control”. It enables you to control playback on Spotify, even if it's not currently playing on the Alexa device you talk to. The following features are available: Playback on a certain device, pause, changing volume, skipping to the next or previous song, seeking in the currently playing track, and toggling shuffle. You can also ask me what is currently playing. How can I help you now?",
    ...
    ERROR_REPROMPT: "Please try again. For further assistance, take a look at the skill's description in the Alexa app or write an e-mail to “alexa@nicolaiweitkemper.de”.",
    ...
    PLAY_SUCCESS: "Okay, I start the playback.",
    PLAY_ERROR: "That did not work. Maybe playback is already running?",
    ...
    PAUSE_ERROR: "That did not work. Maybe playback is already paused?",
    ...
    ERR_NO_TOKEN: "You haven't linked this skill to Spotify yet. In order to do that, open the Alexa app and follow the instructions.",
    ...
    ERR_REASON: {
      ...
      NO_ACTIVE_DEVICE: "I don't see any active device to perform this action on.",
